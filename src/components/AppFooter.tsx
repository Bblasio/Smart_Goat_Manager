...
export const AppFooter: React.FC<AppFooterProps> = () => {
  ...
  return (
    <footer className="no-print border-t border-stone-200 dark:border-stone-800 bg-stone-50/70 dark:bg-stone-900/90 text-stone-600 dark:text-stone-400 mt-auto mb-16 lg:mb-0 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        {/* Streamlined Minimal Footer: Copyright, Version, and Scroll to Top */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-stone-500 dark:text-stone-400">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              onClick={scrollToTop}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white dark:bg-stone-800 border border-stone-200 dark:border-stone-700 hover:bg-stone-100 dark:hover:bg-stone-700 text-stone-700 dark:text-stone-200 font-medium text-xs transition-colors shadow-2xs active:scale-98"
